...
Strada = [
  ...
  member(casa(la_dreapta(y,x),   _,            verde,     _,     _,     _), Strada), %6
  ...
  member(casa(langa(t,s),    _,            _,         _,     _,     chesterfields), Strada), %11
  member(casa(a,   _,            _,         cal,   _,     _), Strada), %12
  member(casa(  langa(a,b),   _,            _,         _,     _,     kools), Strada), %12
  ...
  member(casa(langa(c,d),   norvegian,    _,         _,     _,     _), Strada), %15
